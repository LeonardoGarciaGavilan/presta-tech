...
export default function Dashboard() {
  ...
  const fetchFromServer = useCallback(async (empresaId, silent = false) => {
    ...
    try {
      ...
      const p1 = await api.get("/prestamos");
      console.log("prestamos OK");

      console.log("clientes...");
      const p2 = await api.get("/clientes");
      console.log("clientes OK");

      console.log("pagos...");
      const p3 = await api.get("/pagos");
      console.log("pagos OK");

      console.log("prestamos resumen...");
      const p4 = await api.get("/prestamos/resumen");
      console.log("prestamos resumen OK");

      console.log("pagos resumen...");
      const p5 = await api.get("/pagos/resumen");
      console.log("pagos resumen OK");
