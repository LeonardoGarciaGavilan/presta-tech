// provincias-municipios.js
// Colocar en: src/utils/provincias-municipios.js
...
export const PROVINCIAS_MUNICIPIOS = {
  ...
  "Bahoruco": [
    "Neyba", "Galván", "Los Ríos", "Tamayo", "Villa Jaragua",
  ],
  "Barahona": [
  ...
  "La Romana": [
    "La Romana", "Casa de Campo", "Guaymate", "Villa Hermosa",
  ],
  "La Vega": [
  ...
  "Santiago Rodríguez": [
    "Sabaneta", "Los Almácigos", "Monción",
  ],
  "Santo Domingo": [
